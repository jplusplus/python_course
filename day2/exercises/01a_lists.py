...
politicians = ["Stefan Löfven", "Jimmie Åkesson", "Åsa Romson", "Anna Kinberg-Batra"]
parties = ["Vänsterpartiet", "Socialdemokraterna", "Miljöpartiet", "Centern", "Folkpartiet", "Moderaterna", "Kristdemokraterna", "Sverigedemokraterna"]
