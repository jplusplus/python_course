...
"""	STEG 4: 
	...
	- Skapa en url med hjälp av funktionen slugify(), t.ex. http://www.mp.se/om/mats-dahlberg
	- Öppna urlen läs html-innehållet på sidan
	- Skicka det här innehållet som en parameter till funktionen scrape_profile_page()
